...
const MyJobs = () => {
    ...
    useEffect(()=>{
        setIsLoading(true)
        fetch('http://localhost:3000/myJobs/lilikheirandish@gmail.com')
        .then(res=>res.json())
     ...
     <div className='my-jobs-container'>
        ...
        <div className='search-box p-2 text-center mb-2' >
            ...
            onChange={(e)=> setSearchText(e.target.value)}
             type="text" name='search' id='search' className='py-2 pl-3 border focus:outline-none lg:w-6/12 mb-4'/>
            <button className='bg-blue text-white font-semibold px-8 py-2 roundes-sm mb-4' onClick={handleSearch}> Search</button>
        </div>
